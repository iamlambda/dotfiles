...
static const char col_gray1[]       = "#0F1215";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_gray1,  col_cyan  }, // focused window and middle bar
};
...
static const Layout layouts[] = {
	...
	{ "|fc|",     centeredfloatingmaster }, 
	{ "|C|",      centeredmaster }, 
	{ "|F|",      togglefullscr },// fullscreen mode  
	{ "[idk]",    monocle },
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_t,      setlayout,      {.v = &layouts[0]} }, // tiled mode
	{ MODKEY|ShiftMask,             XK_x,      setlayout,      {.v = &layouts[1]} }, // centered floated master
	{ MODKEY,                       XK_m,      setlayout,      {.v = &layouts[2]} }, // centered master
	{ MODKEY,                       XK_f,      setlayout,      {.v = &layouts[3]} }, // fullscreen mode
